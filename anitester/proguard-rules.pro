...
-keep,includedescriptorclasses class anitester.**$$serializer { *; }
-keepclassmembers class anitester.** {
    *** Companion;
}
-keepclasseswithmembers class anitester.** {
    kotlinx.serialization.KSerializer serializer(...);
}
...
-keep,allowoptimization class anitester.** { *; }
-keep class anitester.MainKt {
    public static void main(java.lang.String[]);
}
-keepdirectories anitester/**
